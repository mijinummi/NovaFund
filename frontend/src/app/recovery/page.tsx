...
function RecoveryContent() {
    ...
    const validateParams = () => {
      try {
        ...
        if (!token || !email || !expiresAt) {
          setState("error");
          setErrorMessage(
            "Invalid recovery link. Missing required parameters.",
          );
          return;
        }
  ...
  const handleRecovery = async () => {
    ...
    try {
      const result = await recoverWithMagicLink();
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  <p className="text-sm text-gray-300">
                    This recovery link is valid and secure. Click below to
                    restore access to your NovaFund wallet.
                  </p>
                </div>
              </div>
            </div>

            <Button onClick={handleRecovery} size="lg" className="w-full">
              Recover Access
            </Button>
          </motion.div>
        );
      ...
      case "success":
        return (
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              Your wallet access has been restored. You&apos;ll be redirected to
              your dashboard in{" "}
              <span className="font-semibold text-purple-400">{countdown}</span>{" "}
              seconds.
            </p>
        ...
        return (
          ...
          >
            ...
            <p className="text-gray-400 mb-6">
              For security reasons, recovery links are only valid for a limited
              time.
            </p>
      ...
      case "error":
        return (
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              {errorMessage ||
                "An error occurred while processing your recovery request."}
            </p>
